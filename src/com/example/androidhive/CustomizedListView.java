...
public class CustomizedListView extends Activity {
	...
	static final String URL = "http://softtech.webege.com/a.xml";
	// XML node keys
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < nl.getLength(); i++) {
			...
			map.put(KEY_UPLOAD_BY, parser.getValue(e, KEY_UPLOAD_BY));
        ...
        list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
	            ...
	            String name1 = (String) obj.get("video").toString();
				
				Toast.makeText(getApplicationContext(), name1, 
						   Toast.LENGTH_LONG).show();
				 Intent in = new Intent(getApplicationContext(), showVideo.class);
	                in.putExtra("video_url",name1);
